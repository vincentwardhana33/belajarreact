                            ...
                            <div className="chat_list">
                              <div className="chat_people">
                                ...
                                <div className="chat_ib">
                                  <h5>
                                    Isabella
                                    <span className="chat_date">Yesterday</span>
                                  </h5>
                                  <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
                            ...
                            <div className="chat_list">
                              <div className="chat_people">
                                ...
                                <div className="chat_ib">
                                  <h5>
                                    Charlotte
                                    <span className="chat_date">Mar 04</span>
                                  </h5>
                                  <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
                            ...
                            <div className="chat_list">
                              <div className="chat_people">
                                ...
                                <div className="chat_ib">
                                  <h5>
                                    Davidson
                                    <span className="chat_date">Feb 18</span>
                                  </h5>
                                  <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
                            ...
                            <div className="chat_list">
                              <div className="chat_people">
                                ...
                                <div className="chat_ib">
                                  <h5>
                                    Elexa ker
                                    <span className="chat_date">Feb 04</span>
                                  </h5>
                                  <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
                            ...
                            <div className="chat_list">
                              <div className="chat_people">
                                ...
                                <div className="chat_ib">
                                  <h5>
                                    Charlotte
                                    <span className="chat_date">Jan 28</span>
                                  </h5>
                                  <p>
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit.
                          ...
                          <div className="msg_history">
                            <div className="incoming_msg">
                              ...
                              <div className="received_msg">
                                <div className="received_withd_msg">
                                  <p>
                                    Coming along nicely, we've got a Lorem ipsum
                            ...
                            <div className="outgoing_msg">
                              <div className="sent_msg">
                                <p>
                                  Great start, I've added some Lorem ipsum dolor
                                  sit amet.
                                </p>
                                <span className="time_date">
                                  12:15 PM | Mar 9
                        ...
                        <div className="card">
                          ...
                          >
                            <div className="card-body para__style">
                              Nulla tincidunt quam justo, in tincidunt tortor
                              sollicitudin a. Donec porta posuere libero sed
                              varius. Phasellus hendrerit commodo sem, at
                              sagittis sapien semper quis. Etiam vitae facilisis
                              nibh. Maecenas erat nisl, blandit at nunc a,
                              lobortis sagittis ex. Maecenas pharetra pulvinar
                              tincidunt.
                            </div>
                          </div>
                        </div>
